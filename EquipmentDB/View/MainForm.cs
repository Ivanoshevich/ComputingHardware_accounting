...
namespace EquipmentDB.Forms
{
    public partial class MainForm : Form
    {
        ...
        private void отчетПоТипамБалансаToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Hide();
        ...
        private void отчетПоКорпусамToolStripMenuItem_Click(object sender, EventArgs e)
        {
           Hide();
        ...
        private void отчетыПоОборудованииСотрудниковToolStripMenuItem_Click(object sender, EventArgs e)
        {
            Hide();
            new Report4().ShowDialog();
            Show();
        }
    }
}
